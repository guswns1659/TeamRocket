...
values (1, '2020-07-11' , 9000, '2020-09-30', 'description', 5, '해양 포유류 보호법 후원 프로젝트', 10000);
insert into project (corporation_id, created_at, current_money, dead_line, description, donators, name, target_money)
values (2, '2020-07-12' , 9000, '2020-09-30', 'description', 5, '해양 쓰레기 줍기 프로젝트', 10000);
insert into project (corporation_id, created_at, current_money, dead_line, description, donators, name, target_money)
values (3, '2020-07-13' , 9000, '2020-09-30', 'description', 5, '순천만 습지에 맹꽁이 살리기 프로젝트', 10000);
insert into project (corporation_id, created_at, current_money, dead_line, description, donators, name, target_money)
values (4, '2020-07-14' , 9000, '2020-09-30', 'description', 5, '북극곰 살리기 프로젝트', 10000);
insert into project (corporation_id, created_at, current_money, dead_line, description, donators, name, target_money)
values (5, '2020-07-15' , 9000, '2020-09-30', 'description', 5, '개마고원에 나무 심기 프로젝트', 10000);
